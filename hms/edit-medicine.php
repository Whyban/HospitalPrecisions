...
$id = $_GET['id'];
$fetch_query = mysqli_query($connection, "select * from tbl_medicine where id='$id'");
...
if(isset($_REQUEST['save-emp']))
{
      ...
      $update_query = mysqli_query($connection, "update tbl_medicine set category='$category', price='$price', status='$status' where id='$id'");
      if($update_query>0)
      {
